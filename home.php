<div class="container">
    <h3><b>Lista de Direcciones Web Acortadas</b></h3>
    <hr class="border-primary">
<div class="col-lg-12">
    <div class="w-100 d-flex justify-content-center align-items-center">
        <label for="" class="control-label">Búsqueda de enlaces</label>
        <input type="text" class="form form-control col-sm-5 ml-2" id="search">
    </div>
    <div class="w-100 d-flex justify-content-end">
        <b>Total de Enlaces Acortados: <span id="total-item">-</span></b>
    </div>
    <div id="url-list">
...
<div class="card p-1 url-item mb-2">
    <div class="card-body">
        <div class="w-100 d-flex-responsive">
            ...
            <div class="w-60 p-2">
                <p class="m-0"><span class="text-muted"><b>Redirecciona hacia: </b></span><span class="url-link"></span></p>
                <p class="m-0"><span class="text-muted"><b>URL acortada: </b></span><span class="url-short"></span></p>
                <p class="m-0"><span class="text-muted"><b>Creado: </b></span><span class="url-created"></span></p>
                <p class="m-0"><span class="text-muted"><b>Último acceso: </b></span><span class="url-last"></span></p>
            </div>
            <div class='w-20 url-data' style="display:none">
                ...
                <hr>
                <p class="m-0 site-title truncate-2">Título</p>
                <small class="site-description truncate-2">Descripción</small>
            </div>
        </div>
    </div>
</div>
...
<script>
            ...
            success:function(resp){
                if (typeof resp == "object" && Object.keys(resp).length > 0) {
                    ...
                    Object.keys(resp).map(function(k){
                        ...
                        card.find('.url-short').text("http://localhost/acortador/b?c="+resp[k].code)
            ...
            complete:function(){
                ...
                $('.copy_to_clip').click(function(e) {
                    ...
                    if (is_copied) {
                        ...
                        _msg.text("URL copiada al portapapeles")
                        ...
                        alert("No se pudo copiar URL al portapapeles")
                    }
                    _inp.remove()
                ...
                $('.remove').click(function(){
                    ...
                    var conf = confirm("Estás segur@ de eliminar "+code+" permanentemente?")
                    if(conf == true)
                        delete_conf(code)
                    end_loader()
                })
    ...
    window.delete_conf = function($code){
        ...
        $.ajax({
            ...
            error: function(err) {
                console.log(err)
                alert("Se produjo un error al eliminar los datos.")
            },
            success:function(resp){
                if (typeof resp == "object" && Object.keys(resp).length > 0) {
